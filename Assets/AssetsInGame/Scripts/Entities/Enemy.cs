...
namespace Slacken.Entities
{
    ...
    public class Enemy : Entity
    {
        ...
        private new void Start()
        {
            ...
            switch (enemyType)
            {
                default: case EnemyType.Normal:
                    theme = sceneTheme.mainTheme.EnemyTheme;
                    break;
                case EnemyType.Fast:
                    theme = sceneTheme.mainTheme.FastEnemyTheme;
                    break;
                case EnemyType.Fat:
                    theme = sceneTheme.mainTheme.FatEnemyTheme;
                        break;
            }
            mainBodyRenderer.color = theme.MainBodyColor;
            particles.GetComponent<ParticleSystem>().startColor = theme.MainBodyColor;
            shooterRenderer.color = theme.ShooterColor;
        ...
        public override void Attack()
        {
            ...
            BulletSpawnValues values = new BulletSpawnValues(shootPoint.transform.position, GameData.baseBulletScaleRatio * transform.localScale, direction, theme.BulletColor, attackDamage, isFriendly: false, empty: false);
        ...
        private void FixedUpdate()
        {
            ...
            // Turn the shooter towards the player
            base.TurnToward(shooter, player.Value.transform.position);
        }
